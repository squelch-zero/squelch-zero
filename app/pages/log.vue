...
useSeoMeta({
  title: 'Log — Squelch Zero',
  ogTitle: 'Log — Squelch Zero',
  description: 'What I did. What I learned. The raw process.',
  ogDescription: 'What I did. What I learned. The raw process.',
})
...
<template>
  <div class="min-h-screen px-6 py-20 max-w-2xl mx-auto">
    ...
    <main>
      ...
      <Elsewhere
        :suggestions="[
          { to: '/writing', label: 'writing', note: 'the polished thoughts' },
          { to: '/pulse', label: 'pulse', note: 'the numbers' },
        ]"
      />
    </main>
  </div>
