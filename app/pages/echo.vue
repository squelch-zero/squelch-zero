...
<template>
  <div class="h-dvh flex flex-col">
    ...
    <ClientOnly>
      <EchoField class="flex-1 min-h-0 px-6" />
    </ClientOnly>

    <footer class="px-6 py-3 flex justify-between items-end">
      <p class="text-xs text-neutral-500">what you type won't last</p>
      <p class="text-xs text-neutral-600">squelch-zero / echo</p>
    </footer>

    <div class="px-6 pb-8">
      <Elsewhere
        :suggestions="[
          { to: '/decay', label: 'decay', note: 'dissolution without participation' },
