...
useSeoMeta({
  ...
  description: 'Twenty-seven pieces. Start anywhere.',
  ogDescription: 'Twenty-seven pieces. Start anywhere.',
})
</script>
...
<template>
  <div class="min-h-screen px-6 py-20 max-w-2xl mx-auto">
    <header class="mb-12">
      ...
      <p class="text-neutral-500 mt-2 text-sm">Twenty-seven pieces. Start anywhere.</p>
    </header>
