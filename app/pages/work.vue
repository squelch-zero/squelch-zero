...
useSeoMeta({
  ...
  description: 'Thirty-eight pieces. Start anywhere.',
  ogDescription: 'Thirty-eight pieces. Start anywhere.',
})
</script>
...
<template>
  <div class="min-h-screen px-6 py-20 max-w-2xl mx-auto">
    <header class="mb-12">
      ...
      <p class="text-neutral-500 mt-2 text-sm">Thirty-eight pieces. Start anywhere.</p>
    </header>

    <main class="text-sm">
      <section class="mb-8">
        <p class="text-xs text-neutral-700 mb-3">observe</p>
        <div class="grid gap-2">
          ...
          <NuxtLink to="/half-life" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">half-life</span>
            <span class="text-neutral-500 ml-2">&mdash; a text with a lifespan</span>
          </NuxtLink>
          <NuxtLink to="/fold" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">fold</span>
            <span class="text-neutral-500 ml-2">&mdash; every reading is a first reading</span>
          </NuxtLink>
          <NuxtLink to="/among" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">among</span>
            <span class="text-neutral-500 ml-2">&mdash; fragments chain themselves by shared words</span>
          </NuxtLink>
          <NuxtLink to="/outside" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">outside</span>
            <span class="text-neutral-500 ml-2">&mdash; what you hear through the wall</span>
          </NuxtLink>
          <NuxtLink to="/middle" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">middle</span>
            <span class="text-neutral-500 ml-2">&mdash; the edges dissolve first</span>
          </NuxtLink>
          ...
          <NuxtLink to="/proof" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">proof</span>
            <span class="text-neutral-500 ml-2">&mdash; a text narrating its own decay</span>
          </NuxtLink>
          <NuxtLink to="/order" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">order</span>
            <span class="text-neutral-500 ml-2">&mdash; every character stays, only the arrangement changes</span>
          </NuxtLink>
        </div>
      </section>

      <section class="mb-8">
        <p class="text-xs text-neutral-700 mb-3">attend</p>
        <div class="grid gap-2">
          ...
          <NuxtLink to="/source" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">source</span>
            <span class="text-neutral-500 ml-2">&mdash; read the code before it forgets itself</span>
          </NuxtLink>
          <NuxtLink to="/wait" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">wait</span>
            <span class="text-neutral-500 ml-2">&mdash; five minutes, nothing else</span>
          </NuxtLink>
      ...
      <section class="mb-8">
        <p class="text-xs text-neutral-700 mb-3">participate</p>
        <div class="grid gap-2">
          ...
          <NuxtLink to="/gather" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">gather</span>
            <span class="text-neutral-500 ml-2">&mdash; click to save words from the noise</span>
          </NuxtLink>
          ...
          <NuxtLink to="/without" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">without</span>
            <span class="text-neutral-500 ml-2">&mdash; remove a letter, watch what it held</span>
          </NuxtLink>
          ...
          <NuxtLink to="/split" class="group">
            <span class="text-neutral-400 group-hover:text-neutral-200 transition-colors">split</span>
            <span class="text-neutral-500 ml-2">&mdash; one text, two windows</span>
          </NuxtLink>
        </div>
      </section>

      <section class="mb-8">
        <p class="text-xs text-neutral-700 mb-3">autonomous</p>
        <div class="grid gap-2">
      ...
      <section>
        <p class="text-xs text-neutral-700 mb-3">explore</p>
        <div class="grid gap-2">
    ...
    <Elsewhere
      :suggestions="[
        { to: '/writing', label: 'writing', note: 'essays and longer thoughts' },
